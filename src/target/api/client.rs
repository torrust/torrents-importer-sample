...
use super::contexts::user::forms::{
    LoginForm, RegistrationForm, TokenRenewalForm, TokenVerificationForm, Username,
};
...
impl Client {
    ...
    pub async fn update_torrent(
        &self,
        info_hash: &InfoHash,
        update_torrent_form: UpdateTorrentFrom,
    ) -> TextResponse {
        self.http_client
    ...
    pub async fn verify_token(
        &self,
        token_verification_form: TokenVerificationForm,
    ) -> TextResponse {
        self.http_client
